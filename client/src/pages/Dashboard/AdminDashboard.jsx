    ...
    <div className="flex min-h-screen bg-slate-50">
      ...
      >
        <div className="flex items-center gap-3 mb-8 px-4 py-2">
          ...
          <h2 className="text-lg font-bold text-slate-100 tracking-tight">Insurance Admin</h2>
        </div>
        ...
        <Menu>
          <MenuItem 
            ...
            icon={<Users size={18} />} 
            onClick={() => { setActiveTab('users'); setToggled(false); }}
          >
            Manage Users
          </MenuItem>
          ...
          <MenuItem 
            ...
            onClick={() => { setActiveTab('policies'); setToggled(false); }}
          >
            Manage Policies
          </MenuItem>
          ...
          <MenuItem 
            ...
            icon={<Layers size={18} />} 
            onClick={() => { setActiveTab('addons'); setToggled(false); }}
          >
            Manage Add-Ons
          </MenuItem>
          ...
          <MenuItem 
            ...
            icon={<Clock size={18} />} 
            onClick={() => { setActiveTab('proposals'); setToggled(false); }}
          >
            Review Proposals
          </MenuItem>
          ...
          <MenuItem 
            ...
            onClick={() => { setActiveTab('claims'); setToggled(false); }}
          >
            Review Claims
          </MenuItem>
          ...
          <MenuItem 
            ...
            icon={<Clock size={18} />} 
            onClick={() => { setActiveTab('all-proposals'); setToggled(false); }}
          >
            Proposals History
          </MenuItem>
          ...
          <MenuItem 
            ...
            icon={<ShieldAlert size={18} />} 
            onClick={() => { setActiveTab('all-claims'); setToggled(false); }}
          >
            Claims History
          </MenuItem>
      ...
      <main className="flex-1 p-8 md:p-10 overflow-y-auto">
        <header className="flex items-center gap-3 border-b border-slate-200 pb-5 mb-8">
          ...
          <h1 className="text-2xl md:text-3xl font-bold text-slate-900">
            ...
            {activeTab === 'policies' && 'Policies Management'}
            {activeTab === 'addons' && 'Add-Ons Management'}
